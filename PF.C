 ...
 //alphas
  ...
  TH1I *histopeakscalib[200];
    ...
    //https://root.cern.ch/root/html534/guides/users-guide/FittingHistograms.html
      ...
      myfiletxt<< imap(i) << "\t" <<parl1[1] << "\t" << parl1[0] << endl;
 ...
 delete[] histopeaks;
  ...
  Int_t C_Chn=a;
    if (a<32) {
      ...
      if (a>=0 && a<16) {C_Chn=a;}      // Vertical, meaning back of detector
      if (a>=16 && a<32) {C_Chn=31-a+16;}    // Vertical, meaning back of detector
    }
    return C_Chn;
  }
